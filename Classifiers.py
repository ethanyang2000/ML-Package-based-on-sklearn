...
class ModelCompare:
    ...
    def showAccurancy(self):
        ...
        for key in list(self.__input.keys()):
            print('The accuracy of '+key+' is '+str(self.__scores[key]))
    ...
    def showCrossValScore(self):
        ...
        for key in list(self.__input.keys()):
            print('The cross val score of ' + key + ' is ' + str(self.__cross_val_scores[key]))
    ...
    def OfficalVoting(self, inp, test):
        ...
        print('predictions of official voting has been completed!')
